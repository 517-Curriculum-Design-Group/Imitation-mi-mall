...
<template>
    <div class="containers">
        ...
        <span class="seq" v-if="!userid"></span>
        <router-link to="/login"><a-button type="default" class="login" v-if="!userid">登录</a-button></router-link>
        <span class="seq" v-if="userid"></span>
        <div class="user flex relative w-auto h-full cursor-pointer" v-if="userid">{{ userid }}
...
.cart:hover,.cart:has(+ .cartdetail:hover) {
