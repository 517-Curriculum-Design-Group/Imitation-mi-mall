...
商城主页，显示一系列商品类别，展示部分商品列表，轮播新品广告。用户可以点击商品类别或单个商品来跳转到商品类别页或商品详情页。
...
对于一个商城来说，除了需要给用户提供清晰好用的前台界面外，还需要为商城的管理人员提供便于更新维护的后台界面。在分析时，我们发现，小米商城和我们平时常用的淘宝商城有所不同：淘宝商城为外部用户提供了成为商家的途径，如个人商户、企业商户等；而小米商城中的商家就是小米公司本身，不对外部用户提供商家资格。这也是小米商城的一大特点。
...
|     state     |     int      | 0\1\2分别对应：未发售\正常发售\缺货 |
...
|    state    |   int    | 0\1\2\3\4分别对应：未支付\待发货\运输中\待取件\已结束 |
| create_time | datetime |                       创建时间                        |
